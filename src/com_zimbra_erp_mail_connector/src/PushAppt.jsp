...
<%
	...
	System.out.println("-------------->>>>>>>Data from jsp"+dbname+password+urladdress+port+msg_id+downloadlink+sessionid);
			...
			System.out.println("AuthToken---->>>>"+auth_token);
                        ...
                        out.print(configuration.sendAppt(dbname,password,urladdress,port,msg_id,downloadlink,push_id,sessionid,auth_token,openerp_id));
